...
Force = -Force + Fext;  %Fext es un valor constante, habria q cambiarlo por algo que dependa del tiempo

####INCISO B (LA FUERZA EN FUNCION DEL TIEMPO)
%Force = -Force + Fext(t);
...
for i=1:nfix
    Yp(2*nnod+fixa(i)) = 0.;  %La aceleracion es 0 en los puntos fijos
end
