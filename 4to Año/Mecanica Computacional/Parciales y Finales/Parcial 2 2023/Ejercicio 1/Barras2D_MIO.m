...
##E(1:n_elementos) = 30*10^6; %en realidad es 30*10^6 segun el pdf pero el profe resuelve con 70*10^6 asi q resuelvo con eso para chequear resultados  % Modulo de elasticidad por ele/^barra
##area(1:n_elementos)= 2;                      % areas de cada elemento/barra
#### Arreglo bidimensional por ser 2D
##xnod = [0 0 ; 0 120; 120 120; 120 0];    % Coordenadas de cada nodo
##icone = [1 2;1 3;1 4];
...
##n_elementos = 11;
##n_nodos = 6;                                % Numero de elementos
##E(1:n_elementos) = 70e9;                     % Modulo de elasticidad por ele/^barra
##area(1:n_elementos) =3*10^-4;                         % areas de cada elemento/barra
##xnod = [0 0 ; 0 3; 3 0 ; 3 3 ;6 0; 6 3];    % Coordenadas de cada nodo
##icone = [1 2 ; 1 3 ; 2 3; 2 4 ;1 4 ; 3 4 ; 3 5; 4 5; 4 6; 3 6 ; 5 6];                % Conectividad de los Nodos
###         e1    e2    e3   e4   e5   e6    e7   e8    e9   e10   e11
##Desplaz =  [0  0  1  1  0  1  0  1  1  0  1  1];            % Desplazamientos por nodo
####Desplaz =[u1 v1 u2 v2 u3 v3 u4 v4 u5 v5 u6 v6] # donde ponemos 0 signifca q es = 0 u1 v1 u3 u4 = 0
##F = [0 0 0 -50e3 0 0 0 -100e3 0 0 0 -50e3 ];       % Fuerzas por nodo
###F = [F1x F1y F2x F2y F3x F3y....
##


% ===============================[Problema 8 Apunte teorico practico]================================
###MUY IMPORTANTE: DEPENDE COMO DEFINAMOS EL ICONE SE VAN A FORMAR LOS ANGULOS
...
##icone = [4 1 ; 4 2 ; 4 3];                % Conectividad de los Nodos
...
n_nodos=3
n_elementos=2;
E(1:n_elementos)=210*10^6;
area(1:n_elementos)=0.0006;
xnod=[0 0 ; 4 0 ; 0 3];
icone=[1 2 ; 3 2 ];
Desplaz =[0 0 1 1 0 0];
F=[0 0 -1000 0 0 0];
