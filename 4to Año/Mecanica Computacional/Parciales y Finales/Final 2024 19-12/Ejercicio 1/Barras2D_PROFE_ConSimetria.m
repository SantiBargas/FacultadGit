...
Nele = 6;
E(1:Nele) = 1*10^9
area = [9*10^-4 ;(4*10^-4)/2 ; 7/10^-4 ; 5*10^-4 ; 9*10^-4 ; 5*10^-4];
xnod= [0 0 ; 0 1 ; 1.5 1; 3 1 ; 3 0];
icone=[1 2 ; 3 4; 4 5; 5 3 ; 1 5; 1 3];
Desplaz=[0 0 0 0 1 0 1 0 1 1];
Fuerzas=[0 0 0 0 0 0 5000 0 0 -5000];
