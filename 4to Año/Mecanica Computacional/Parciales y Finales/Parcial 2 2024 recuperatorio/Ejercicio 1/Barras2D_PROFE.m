...
#Parcial 2 2024 recuperatorio
Nele = 5;
E(1:Nele) = 10*10^9;
##area=[ 2*10^-4 ; 3*10^-4 ; 2*10^-4 ; 3*10^-4 ; 2*10^-4];
area=[ 2*10^-2 ; 3*10^-4 ; 2*10^-4 ; 3*10^-4 ; 2*10^-2]; #Aumentamos el area de la barra 1 y 5 para que el nodo 2 no se desplaze mas de 0.05
xnod= [0 0 ; 2 0  ; 2 1.4 ; 4 0];
icone=[1 2; 1 3 ; 2 3 ; 3 4; 2 4];
Desplaz=[0 0 1 1 1 1 1 0];
Fuerzas=[0 0 0 0 0 -45000 0 0];
