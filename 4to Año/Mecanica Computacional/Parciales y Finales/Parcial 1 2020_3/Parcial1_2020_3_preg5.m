...
NEU=[
     ...
     % Nodos 1 a 7 con q = -100*xnode(nodo, 1)
     1, (-100*xnode(1,1)), 1;  % Nodo 1
     2, (-100*xnode(2,1)), 1;  % Nodo 2
     3, (-100*xnode(3,1)), 1;  % Nodo 3
     4, (-100*xnode(4,1)), 1;  % Nodo 4
     5, (-100*xnode(5,1)), 1;  % Nodo 5
     6, (-100*xnode(6,1)), 1;  % Nodo 6
     7, (-100*xnode(7,1)), 1;  % Nodo 7
];
