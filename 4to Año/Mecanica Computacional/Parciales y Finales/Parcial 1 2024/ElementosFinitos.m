...
K_el = -k * [2 -2; -2 2] % Matriz de rigidez del elemento
...
K_global(1,:) = 0;  % Condición Dirichlet
K_global(1,1) = 1; % Condición Dirichlet
F_global(1) = 10;  % Temperatura en el nodo x=2
M_global(1,:) = 0;  # La fila correspondiente al nodo Dirichlet en M se anula
M_global(1,1) = 1;  # El elemento (1,1) se fija en 1


F_global(5) += 1; % Condición Neumann
