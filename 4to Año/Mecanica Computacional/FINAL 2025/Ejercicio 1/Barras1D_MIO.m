...
% ===============================[Problema 3]=================================
n_elementos = 2 ; % Número total de elementos
n_nodos = 3; % Número total de nodos
E = [200*10^9 70*10^9]; % Módulos de elasticidad para cada elemento [Pa]
area = [4*10^-4 2*10^-4]; % Áreas de cada elemento [m^2]
xnod = [0 ; 1 ; 2];
icone = [1 2 ; 2 3];
Desplaz = [0 1 1];
Fuerzas = [0 0 -40];
