...
##Nele = 6;
##E(1:Nele) = 70*10^6;                     % Modulo de elasticidad por ele/^barra
...
##Fuerzas = [0 0 0 -50 0 0 0 -50 ];       % Fuerzas por nodo
...
##Nele = 3;
##E(1:Nele) = 1 ;                   % Modulo de elasticidad por ele/^barra
##area(1:Nele)=1;                        % areas de cada elemento/barra
...
##Fuerzas = [ 0   0    0   0   0    0  1  0 ];       % Fuerzas por nodo
