...
glm::vec3 view_target = {0.f,0.f,0.f}, view_pos = {0.f,0.f,25.f};
...
void mouseMoveCallback(GLFWwindow* window, double xpos, double ypos) {
	...
	case MouseAction::Zoom:
		...
		view_fov = std::min(999999999.f,std::max(5.f,view_fov));
	break;
...
void setMatrixes(Shader &shader, bool t, glm::vec2 minMaxY, glm::vec2 minMaxX) {
	auto ms = common_callbacks::getMatrixes();
	
	float despY = (minMaxY[1]-minMaxY[0])/2;
	float despX = (minMaxX[1]-minMaxX[0])/2;
	
	glm::mat4 rotacionX = glm::mat4(	1.000f, 			0.000f,				0.000f,				0.000f,
										0.000f,				cos(M_PI*1.5f), 	sin(M_PI*1.5f),		0.000f,
										0.000f,				-sin(M_PI*1.5f), 	cos(M_PI*1.5f),		0.000f,
										0.000f, 			0.000f,				0.000f,				1.000f);
	
	glm::mat4 rotacionZ = glm::mat4(	cos(M_PI*1.5f), 	sin(M_PI*1.5f),		0.000f, 		0.000f,			
										-sin(M_PI*1.5f),	cos(M_PI*1.5f),		0.000f,			0.000f, 		
										0.000f, 			0.000f,				1.000f,			0.000f,
										0.000f, 			0.000f,				0.000f,			1.000f);
	
	glm::mat4 transalacion = glm::mat4(	1.000f, 	0.000f,		0.000f, 		0.000f,			
										0.000f,		1.000f,		0.000f,			0.000f, 		
										0.000f, 	0.000f,		1.000f,			0.000f,
										-despX, 	-despY,		0.000f,		1.000f);
	
	if(t){
		shader.setMatrixes(ms[0]*rotacionX*rotacionZ*transalacion,ms[1],ms[2]);
	} else {
		shader.setMatrixes(ms[0]*rotacionX*rotacionZ,ms[1],ms[2]);
	}
}
