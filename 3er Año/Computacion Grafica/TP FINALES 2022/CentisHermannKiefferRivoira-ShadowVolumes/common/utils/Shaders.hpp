...
public:
	...
	Shader(const std::string &fname, bool with_geo=false);
	Shader(const std::string &vertex_fname, const std::string &fragment_fname,const std::string &geometry_fname="");
	
	void load(const std::string &fname, bool with_geo=false);
	void load(const std::string &vertex_fname, const std::string &fragment_fname,const std::string &geometry_fname="");
	...
	void setMatrixes(const glm::mat4 &object, const glm::mat4 &camera, const glm::mat4 &view, const glm::mat4 &projection);
