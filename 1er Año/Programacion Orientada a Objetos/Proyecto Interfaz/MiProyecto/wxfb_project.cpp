...
wxfbExample::wxfbExample( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	m_staticText24->SetFont( wxFont( 22, wxFONTFAMILY_SCRIPT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, true, wxT("Comic Sans MS") ) );

	bSizer35->Add( m_staticText24, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_staticText211->SetFont( wxFont( 14, wxFONTFAMILY_SCRIPT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, true, wxT("Comic Sans MS") ) );
	...
	// Cell Defaults
	GrillaSala->SetDefaultCellBackgroundColour( wxSystemSettings::GetColour( wxSYS_COLOUR_INFOBK ) );
...
MyDialog6::MyDialog6( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	bSizer151->Add( m_Tutor, 1, wxALL, 5 );
	...
	m_staticText551 = new wxStaticText( this, wxID_ANY, wxT("Edad:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText551->Wrap( -1 );
	m_staticText551->SetFont( wxFont( 14, wxFONTFAMILY_SCRIPT, wxFONTSTYLE_ITALIC, wxFONTWEIGHT_BOLD, false, wxT("Comic Sans MS") ) );

	bSizer1551->Add( m_staticText551, 0, wxALL, 5 );

	m_Edad = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	m_Edad->SetFont( wxFont( 10, wxFONTFAMILY_SWISS, wxFONTSTYLE_ITALIC, wxFONTWEIGHT_BOLD, false, wxT("Arial") ) );

	bSizer1551->Add( m_Edad, 1, wxALL, 5 );
	...
	m_button9 = new wxButton( this, wxID_ANY, wxT("Siguiente"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer43->Add( m_button9, 0, wxALL, 5 );

	m_button10 = new wxButton( this, wxID_ANY, wxT("Cancelar"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer43->Add( m_button10, 0, wxALL, 5 );
	...
	// Connect Events
	m_button9->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MyDialog6::ClickSiguiente ), NULL, this );
	m_button10->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MyDialog6::ClickCancelar ), NULL, this );
}

MyDialog6::~MyDialog6()
{
	// Disconnect Events
	m_button9->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MyDialog6::ClickSiguiente ), NULL, this );
	m_button10->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( MyDialog6::ClickCancelar ), NULL, this );
...
MyDialog7::MyDialog7( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	bSizer141->Add( bSizer1551, 1, wxEXPAND, 5 );
